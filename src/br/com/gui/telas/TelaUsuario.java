...
// método para consultar usúarios 
...
// criando o metódo alterar dados do usúrio
    ...
    private void alterar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty()) || (txtUsuLogin.getText().isEmpty()) || (txtUsuSenha.getText().isEmpty())) {
                ...
                // a linha abaixo atualiza a tabela com os dados do usúario
                // a estrtrutura abaixo é usada para alterar os dados do usúario
                int adicionado = pst.executeUpdate();
                // a linha abaixo serve de apoio para o entendimento da lógica
                // System.out.println(adicionado);
                if (adicionado > 0) {
...
// criando o método remover
    private void remover(){
        ...
        int comfirma = JOptionPane.showConfirmDialog(null,"Tem serteza que deseja remover esse usúario","Atenção",JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Usúarios");
        setPreferredSize(new java.awt.Dimension(498, 447));
        ...
        btnUsuCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gui/icones/create.png"))); // NOI18N
        ...
        btnUsuRead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gui/icones/read.png"))); // NOI18N
        ...
        btnUsuUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gui/icones/update.png"))); // NOI18N
        ...
        btnUsuDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gui/icones/delete.png"))); // NOI18N
        ...
        setBounds(0, 0, 499, 454);
    }// </editor-fold>//GEN-END:initComponents

    private void btnUsuReadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuReadActionPerformed
        // chamando o método cosultar
        consultar();
    }//GEN-LAST:event_btnUsuReadActionPerformed

    private void btnUsuCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuCreateActionPerformed
        // chamando o método adiciomar
        adicionar();
